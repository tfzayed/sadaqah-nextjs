            ...
            <React.Fragment key={`menu-${i}`}>
              {menu.hasChildren ? (
                <li className="nav-item nav-dropdown group relative">
                  ...
                  <ul
                    className="nav-dropdown-list hidden group-hover:block lg:invisible lg:absolute lg:left-1/2 lg:transform lg:-translate-x-1/2 lg:block lg:opacity-0 lg:group-hover:visible lg:group-hover:opacity-100"
                  >
